    ...
    <>
      <div className="hidden md:flex fixed top-0 left-0 w-full z-50 p-4 pt-8 justify-between items-center pointer-events-none">
        <button
          ...
          className="pointer-events-auto ml-4 focus-visible:outline-orange-light rounded-lg"
        ...
        <div className="pointer-events-auto flex gap-3 mr-4">
          {[
            ...
            { name: 'mail', label: 'Contact', action: () => { setPage('contact'); window.scrollTo(0, 0); } }
          ].map(s => {
